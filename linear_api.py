class Pile:
    def __init__(self):
        print("[Pile] 🏗️ Création d'une nouvelle pile vide.")
        self._items = []
...
class File:
    def __init__(self):
        print("[File] 🏗️ Création d'une nouvelle file vide.")
        self._items = []
...
class ListeChainee:
    def __init__(self):
        print("[Liste] 🏗️ Création d'une Liste Chaînée vide.")
        self.head = None
    ...
    def supprimer(self, value):
        print(f"[Liste] 🗑️ Tentative de suppression de '{value}'...")
        if self.head is None:
